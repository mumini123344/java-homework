...
public class CircleAbstract extends FigureAbstract implements IResizableCircle, IValidCircle, Comparable<CircleAbstract> {
    ...
    @Override
    public int compareTo(CircleAbstract o) {
